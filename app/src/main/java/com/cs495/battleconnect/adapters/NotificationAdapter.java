...
import com.cs495.battleconnect.holders.NotificationHolder;
...
import static com.cs495.battleconnect.utility.StringToolkit.makeSectionOfTextBold;
...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationHolder>  {
    ...
    public void onBindViewHolder(NotificationHolder holder, int position) {
        ...
        SpannableStringBuilder idStr = StringToolkit.makeSectionOfTextBold("ID: " + currentItem.getId(), "ID:");
        SpannableStringBuilder priorityStr = StringToolkit.makeSectionOfTextBold("Priority: " + currentItem.getPriority(), "Priority:");
        SpannableStringBuilder senderStr = StringToolkit.makeSectionOfTextBold("Sender: " + currentItem.getSender(), "Sender:");
        SpannableStringBuilder messageStr = StringToolkit.makeSectionOfTextBold("Message: " + currentItem.getMessage(), "Message:");

        holder.id.setText(idStr);
        holder.priority.setText(priorityStr);
        holder.sender.setText(senderStr);
